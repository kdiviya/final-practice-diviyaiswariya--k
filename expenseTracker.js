...
// readline-sync library used to get input from user
...
//Declare the string datatype, which is used to collect user input
let userChoice = '';
//Declare the number datatype, which is used to calculate the total expense for each categories. 
let totalFuel = 0;
let totalGrocery = 0;
let totalMedical = 0;
let totalMisc = 0;
...
//Declare the const datatype which ensure that the values cannot be changed in the code. These constants having max spend amount for the month.
const fuelMax = 200;
...
do {
    ...
    let lowerCase = expenseName.toLowerCase(); //used .toLowerCase to convert the expenseName string into lowercase.

    //used the if-else statements to add the element in the corressponding category array
...
console.log("your Total expense is: $", totalExpense.toFixed(2));

/* Output
Enter the expense name? fuel
Enter the expense amount? 45
Do you want to enter other expense, enter Y/N? y
Enter the expense name? fuel
Enter the expense amount? 20
Do you want to enter other expense, enter Y/N? y
Enter the expense name? grocery
Enter the expense amount? 25
Do you want to enter other expense, enter Y/N? y
Enter the expense name? grocery
Enter the expense amount? 10
Do you want to enter other expense, enter Y/N? y
Enter the expense name? medical
Enter the expense amount? 50
Do you want to enter other expense, enter Y/N? y
Enter the expense name? EB
Enter the expense amount? 60
Do you want to enter other expense, enter Y/N? n
Total Fuel expenses: $ 65.00
Total Grocery expenses: $ 35.00
Total Medical expenses: $ 50.00
Total Miscellaneous expenses: $ 60.00
your Total expense is: $ 210 */